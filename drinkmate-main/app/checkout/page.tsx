          ...
          <div className="lg:col-span-3 bg-white rounded-2xl p-6 shadow-lg self-start">
            ...
            <div className="border-t border-gray-200 pt-6">
              ...
              <div className="space-y-4">
                ...
                <div
                  className={`border-2 rounded-lg p-4 cursor-pointer transition-all duration-200 ${selectedPaymentMethod === "card"
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex items-center justify-end">
                        <div className="flex -space-x-1">
                          <div className="bg-white rounded p-1 flex items-center justify-center h-8 w-12 border border-gray-100 relative z-30">
                            <Image
                          ...
                          <div className="bg-white rounded p-1 flex items-center justify-center h-8 w-12 border border-gray-100 relative z-20">
                            <Image
                          ...
                          <div className="bg-white rounded p-1 flex items-center justify-center h-8 w-12 border border-gray-100 relative z-10">
                            <Image
